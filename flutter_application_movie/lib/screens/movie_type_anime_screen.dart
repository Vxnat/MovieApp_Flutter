...
class MovieTypeAnime extends StatefulWidget {
  const MovieTypeAnime({
    super.key,
  });

  @override
  State<MovieTypeAnime> createState() => _MovieTypeAnimeState();
}

class _MovieTypeAnimeState extends State<MovieTypeAnime> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: Apis.getDataMovieAnime(0),

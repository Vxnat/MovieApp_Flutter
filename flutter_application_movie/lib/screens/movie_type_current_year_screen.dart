...
class MovieTypeCurrentYear extends StatefulWidget {
  const MovieTypeCurrentYear({
    super.key,
  });

  @override
  State<MovieTypeCurrentYear> createState() => _MovieTypeCurrentYearState();
}

class _MovieTypeCurrentYearState extends State<MovieTypeCurrentYear> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: Apis.getDataMovieCurrentYear(0),

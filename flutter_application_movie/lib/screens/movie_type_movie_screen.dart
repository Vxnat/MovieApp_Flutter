...
class MovieTypeMovie extends StatefulWidget {
  const MovieTypeMovie({
    super.key,
  });

  @override
  State<MovieTypeMovie> createState() => _MovieTypeMovieState();
}

class _MovieTypeMovieState extends State<MovieTypeMovie> {
  @override
  void dispose() {
    super.dispose();
  }

...
class MovieTypeFunny extends StatefulWidget {
  const MovieTypeFunny({super.key});

  @override
  State<MovieTypeFunny> createState() => _MovieTypeFunnyState();
}

class _MovieTypeFunnyState extends State<MovieTypeFunny> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: Apis.getDataMovieFunny(0),
